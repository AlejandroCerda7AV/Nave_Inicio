...
void CGame::Iniciando(){
	...
	nave=new Objeto(screen,"../Data/MiNave.bmp",(WIDTH_SCREEN/2),(HEIGHT_SCREEN-80);
	menu=new Objeto(screen,"../Data/Fondo juego.bmp",0.0);

	enemigoArreglo*[10];
	for(int i=0;i<10;i++)
		enemigoArreglo[i]=new Objeto(screen,"../Data/enemigo.bmp",i*64,0);
